## Diceether
----
Dicether is an Ethereum based dice game. It uses a smart contract based state channel implementation to provide a fast, secure and fair gambling experience. No external services are needed.
User can invite friends and earn 33% of the house edge!

https://etherscan.io/address/0xaEc1F783B29Aab2727d7C374Aa55483fe299feFa?utm_source=StateOfTheDApps#code

https://github.com/dicether/contracts

```javascript
/**
 *Submitted for verification at Etherscan.io on 2019-03-31
*/
//  9,427 txs to (20 Dec 2020)
